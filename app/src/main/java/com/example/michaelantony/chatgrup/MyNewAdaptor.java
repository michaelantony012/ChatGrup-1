package com.example.michaelantony.chatgrup;
...
/**
 * Created by Michelle on 11/3/2017.
 */

public class MyNewAdaptor extends RecyclerView.Adapter<MyNewAdaptor.MAdapter> {

    List<JSONObject> dataJson = new ArrayList<>();
    JSONArray arrayJson;

    public MyNewAdaptor(JSONArray jason) {
        arrayJson = jason;
